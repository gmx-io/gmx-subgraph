function createMarket(
  ...
  return new MarketInfo2(marketToken, indexToken, longToken, shortToken);
}

export class MarketInfo2 {
  constructor(
...
export let markets = new Map<string, MarketInfo2>();
...
markets.set(
  ...
  createMarket(
    "0x1529876a9348d61c6c4a3eee1fe6cbf1117ca315", // 0x1529876A9348D61C6c4a3EEe1fe6CbF1117Ca315
    "0xe39ab88f8a4777030a534146a9ca3b52bd5d43a3", // 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3
    "0xe39ab88f8a4777030a534146a9ca3b52bd5d43a3", // 0xe39Ab88f8A4777030A534146A9Ca3B52bd5D43A3
    "0x04fc936a15352a1b15b3b9c56ea002051e3db3e5" // 0x04FC936a15352a1b15b3B9c56EA002051e3DB3e5
  )
);
markets.set(
